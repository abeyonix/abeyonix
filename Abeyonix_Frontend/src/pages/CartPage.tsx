...
import { updateGuestCartItem, removeGuestCartItem } from "@/utils/guestCart";
...
const CartPage = () => {
  ...
  const handleIncreaseQty = async (itemId: number, currentQty: number) => {
    if (!user) {
      await updateGuestCartItem(itemId, currentQty + 1);
      await refetchCart();
      return;
    }
          ...
          {cartItems.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-gray-500 max-w-md mb-6">
                Looks like you haven’t added anything yet. Go ahead, make your
                cart happy — it loves company!
              </p>

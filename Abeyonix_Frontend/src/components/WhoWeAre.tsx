        ...
        : "translate-x-12 translate-y-12 opacity-0"
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold font-playfair text-gray-900 leading-tight">
              We don’t just build products — we build solutions that perform.
            </h2>

            <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
              We are a technology-driven company focused on building advanced
              drones, robotics systems, and IoT solutions tailored for
              real-world applications. Our work combines engineering precision
              with practical innovation — delivering products and services that
              meet the needs of students, creators, startups, and industries.
              From custom drone builds to intelligent automation systems, we
              turn ideas into reliable, high-performance solutions.
            </p>
